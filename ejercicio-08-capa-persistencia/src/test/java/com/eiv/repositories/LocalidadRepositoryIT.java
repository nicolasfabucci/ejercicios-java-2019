...
public class LocalidadRepositoryIT {
    ...
    @Test
    @Transactional
    public void givenLocalidad_whenFindById_thenDelete() {

        LocalidadRepository localidadRepository = new LocalidadRepository(dataSource);
        
        localidadRepository.findById(1L).ifPresent(localidadEntity -> {
            
            localidadRepository.delete(localidadEntity);
        });
        
        Optional<LocalidadEntity> optional = localidadRepository.findById(5L);
